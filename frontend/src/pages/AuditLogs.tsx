...
export default function AuditLogs() {
 ...
 <label className="block text-xs font-medium text-gray-500 dark:text-themeWhite/60 mb-1">
 Filter by resource
 </label>
 <Input
 ...
 <div className="p-8 text-center text-sm text-gray-500 dark:text-themeWhite/60">
 <ShieldCheck className="w-8 h-8 mx-auto mb-2 opacity-40" />
 No audit log entries match the current filter.
 </div>
 ) : (
 <table className="w-full text-sm">
 <thead className="bg-gray-50 dark:bg-gray-800/50 text-xs text-gray-500 dark:text-themeWhite/60">
 <tr>
 <Th>When</Th>
 <Th>User</Th>
 <Th>Method</Th>
