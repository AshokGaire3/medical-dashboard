...
export function MedicationsTab({ patientId }: { patientId: number }) {
 ...
 roles={['Doctor', 'Admin']}
 fallback={
 <p className="text-xs text-gray-500 dark:text-themeWhite/60 italic">
...
function Section({
 ...
 return (
 <div>
 <p className="text-xs font-medium tracking-wide text-gray-500 dark:text-themeWhite/60 mb-2">
 {label}
 </p>
