...
const CustomLineChart: React.FC<LineChartProps> = ({ data, dataKeys, xAxisKey, title }) => {
 ...
 {title && <h3 className="text-xl font-bold text-themeBlack dark:text-themeWhite tracking-tight mb-6 border-b-2 border-themeBlack dark:border-themeWhite pb-4">{title}</h3>}
