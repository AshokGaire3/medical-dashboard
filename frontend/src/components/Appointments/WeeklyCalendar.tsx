        ...
        <div className="min-w-[900px]">
          <div className="grid grid-cols-[60px_repeat(7,1fr)] border-b border-themeBlack dark:border-themeWhite bg-gray-50 dark:bg-gray-800/60">
            ...
            {days.map((d) => (
              ...
              >
                <p className="text-[11px] uppercase tracking-wide text-themeBlack/60 dark:text-themeWhite/60">
                  {format(d, 'EEE')}
                </p>
                <p
          ...
          {HOURS.map((hour) => (
            ...
            >
              <div className="px-2 py-2 text-[11px] text-themeBlack/60 dark:text-themeWhite/60 text-right">
