...
export function Modal({
 ...
 {description ? (
 <p className="text-sm text-gray-500 dark:text-themeWhite/60 mt-0.5">{description}</p>
 ) : null}
 </div>
 <button
 onClick={onClose}
 aria-label="Close"
 className="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-themeWhite/60"
 >
 <X className="w-5 h-5" />
 </button>
 </header>
